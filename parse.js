;(function(window, document, undefined) {
   ...
   parse.fn.toNumber = function(precision) {
      ...
      return helpers.thousandsNumberSeparator(value);
   };

   parse.fn.toCurrency = function() {

      var value = helpers.precisionNumber(this.value, 2);
      value = helpers.thousandsNumberSeparator(value);
   ...
   */
   ...
   helpers.precisionNumber = function(value, precision) {
   ...
   helpers.thousandsNumberSeparator = function(value) {
